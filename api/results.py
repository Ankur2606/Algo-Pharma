...
GET /api/results/list
  - Returns projects belonging to the current user (admin sees all).
"""
...
def _serialize_post(pp, raw) -> dict:
    ...
    sentiment = pp.sentiment_json or {}
...
def list_projects(
    ...
    with SessionLocal() as session:
        if current_user.role == "admin":
            ...
            projects = (                                       # ← added ownership filter
